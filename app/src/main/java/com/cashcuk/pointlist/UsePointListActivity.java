 ...
 * 사용포인트 내역
 */
public class UsePointListActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case StaticDataInfo.RESULT_CODE_ERR:
                    Toast.makeText(UsePointListActivity.this, getResources().getString(R.string.str_http_error), Toast.LENGTH_SHORT).show();
                    break;
                case StaticDataInfo.RESULT_CODE_200:
                    if(msg.arg1 == StaticDataInfo.RESULT_CODE_MY_POINT) {
                        ...
                        if(mPageNo==1) {
                            adapter = new PointLIstAdapter(UsePointListActivity.this, arrPointInfo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_use_list);
        ...
        ibRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPageNo = 1;
                new RequestPointList(UsePointListActivity.this, StaticDataInfo.MODE_POINT_LIST_USE, STR_REQUEST_LIST_CNT, handler, mPageNo);
                new GetChargePoint(UsePointListActivity.this, handler);
            }
        });

        ((TitleBar) findViewById(R.id.title_bar)).setTitle(getResources().getString(R.string.str_use_point));

        llProgress = (LinearLayout)findViewById(R.id.ll_progress_circle);
        Intent intent = getIntent();
        View layoutMyPoint = (View)findViewById(R.id.layout_my_point);
        txtMyPoint = (TextView) layoutMyPoint.findViewById(R.id.txt_title_my_point);
...
//        arrString.add(getResources().getString(R.string.str_down_character)); //캐릭터 다운
        ...
        DlgListAdapter dlgAdapter = new DlgListAdapter(UsePointListActivity.this, arrString);
...
//                    Intent intent = new Intent(UsePointListActivity.this, DlgCharaterCategory.class);
...
//                    startActivity(intent);
    ...
    public void RequestInputPoint(){
        ...
        if(mMyPoint<Integer.parseInt(strChangeMinMoney)){
            intent = new Intent(UsePointListActivity.this, DlgBtnActivity.class);
