 ...
 * 충전금 내역
 */
public class ChargeAccrueListActivity extends Activity {
    ...
    private ChargeNewListAdapter adapter=null;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case StaticDataInfo.RESULT_CODE_ERR:
                    Toast.makeText(ChargeAccrueListActivity.this, getResources().getString(R.string.str_http_error), Toast.LENGTH_SHORT).show();
                    break;
                case StaticDataInfo.RESULT_CODE_200:
                    if(msg.arg1==GetChargeAmount.MSG_ARG){
                        //txtMyCharge.setText((String)msg.obj);
                        txtMyCharge.setText(StaticDataInfo.makeStringComma((String)msg.obj));
                        ...
                        if(mPageNo==1) {
                            adapter = new ChargeNewListAdapter(ChargeAccrueListActivity.this, arrChargeInfo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new RequestChargeList(ChargeAccrueListActivity.this, StaticDataInfo.MODE_POINT_LIST_ACCRUE, STR_REQUEST_LIST_CNT, handler, mPageNo);
            }
        });

        ((TitleBar) findViewById(R.id.title_bar)).setTitle(getResources().getString(R.string.str_charge_money_list));
        ...
        new RequestChargeList(ChargeAccrueListActivity.this, StaticDataInfo.MODE_POINT_LIST_ACCRUE, STR_REQUEST_LIST_CNT, handler, mPageNo);
        new GetChargeAmount(ChargeAccrueListActivity.this, handler);
    }
