 ...
 * 누적 or 사용충전금 adapter
 */
public class ChargeNewListAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private ViewHolder vh = null;
    private ArrayList<ChargeListDataInfo> arrChargeInfo = new ArrayList<ChargeListDataInfo>();

    public ChargeNewListAdapter(Context context, ArrayList<ChargeListDataInfo> arrChargeInfo){
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v==null){
            vh = new ViewHolder();
            v = mInflater.inflate(R.layout.charge_listnew_item, null);
            ...
            vh.txtChargeCd = (TextView) v.findViewById(R.id.txt_use_money_cd);
        ...
        if(StaticDataInfo.STR_CHARGE_CODE_TAKE.equals(arrChargeInfo.get(position).getStrChargeCode())){
            vh.txtChargeCd.setText("-");
        }else{
            vh.txtChargeCd.setText("+");
        }
    ...
    class ViewHolder{
        ...
        public TextView txtChargeCd; //금액 플러스,마이너스
